...
public class OptionsUI : MonoBehaviour
{
    ...
    {
        float volume = Mathf.Round(SoundManager.Instance.GetVolume() * 10f);
        soundEffectsText.text = $"Sound Effects: {volume}";
        volume = Mathf.Round(MusicManager.Instance.GetVolume() * 10f);
